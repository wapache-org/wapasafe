...
package org.wapache.security.oauth2.common.message;
...
import org.wapache.security.oauth2.common.parameters.BodyURLEncodedParametersApplier;
import org.wapache.security.oauth2.common.parameters.FragmentParametersApplier;
import org.wapache.security.oauth2.common.parameters.JSONBodyParametersApplier;
import org.wapache.security.oauth2.common.parameters.OAuthParametersApplier;
import org.wapache.security.oauth2.common.parameters.QueryParameterApplier;
import org.wapache.security.oauth2.common.parameters.WWWAuthHeaderParametersApplier;
...
public class OAuthResponse implements OAuthMessage {
    ...
    // import javax.servlet.http.HttpServletResponse.SC_FOUND;
    ...
    public static OAuthErrorResponseBuilder errorResponse(OAuthProblemException e) {
        return new OAuthErrorResponseBuilder(SC_FOUND).error(e);
    }
    ...
    public static class OAuthErrorResponseBuilder extends OAuthResponseBuilder {
        ...
        public OAuthErrorResponseBuilder error(OAuthProblemException ex) {
            ...
            return location(ex.getRedirectUri());
        }

 ...
 */
package org.wapache.security.jose.jwe;
...
import org.wapache.security.jose.jwe.encryption.ContentEncryptMethod;
import org.wapache.security.jose.jwe.encryption.DecryptingKey;
import org.wapache.security.jose.jwe.encryption.EncryptingKey;
import org.wapache.security.jose.jwe.encryption.KeyEncryptMethod;
import org.wapache.security.jose.jwe.io.JWEHeaderWriter;
...
public class JWE {
    ...
    public static final class Builder extends CustomizableBuilder<JWE> {
        ...
        public <EK extends EncryptingKey, DK extends DecryptingKey> Builder encrypt(KeyEncryptMethod<EK, DK> keyEncryptMethod,
            ...
            return setContentEncryption(contentEncryptMethod.encrypt(TokenCodec.base64Encode(header), payload, cek.getContentEncryptionKey()));
        }

 ...
 */
package org.wapache.security.jose.jws;

import org.wapache.security.commons.encodedtoken.TokenCodec;
import org.wapache.security.commons.customizable.CustomizableBuilder;
import org.wapache.security.jose.jws.io.JWSHeaderWriter;
import org.wapache.security.jose.jws.signature.SignatureMethod;
import org.wapache.security.jose.jws.signature.SigningKey;
import org.wapache.security.jose.jws.signature.VerifyingKey;
...
public class JWS {
    ...
    public <SK extends SigningKey, VK extends VerifyingKey> boolean validate(SignatureMethod<SK, VK> method,
        ...
        if (rawString == null) {
            return method.verify(signature, TokenCodec.base64Encode(new JWSHeaderWriter().write(header)), TokenCodec.base64Encode(payload), verifyingKey);
        } else {
    ...
    public static final class Builder extends CustomizableBuilder<JWS> {
        ...
        public <SK extends SigningKey, VK extends VerifyingKey> Builder sign(SignatureMethod<SK, VK> method,
            ...
            return setSignature(method.calculate(TokenCodec.base64Encode(header), TokenCodec.base64Encode(payload), signingKey));
        }

 ...
 */
package org.wapache.security.jose.jwe.io;

import org.wapache.security.commons.customizable.CustomizableEntityReader;
import org.wapache.security.jose.jwe.JWE;

final class JWEHeaderParser extends CustomizableEntityReader<JWE, JWE.Builder> implements JWEConstants {

    public JWEHeaderParser(JWE.Builder builder) {
        super(builder);
    }

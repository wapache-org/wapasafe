 ...
 */
package org.wapache.security.jose.jws.signature.impl;
...
public class SignatureMethodRSAImplTest {
    ...
    public void testCalculate() throws Exception{
        ...
        assertEquals("cC4hiUPoj9Eetdgtv3hF80EGrhuB__dzERat0XF9g2VtQgr9PJbu3XOiZj5RZmh7"+
                ...
                sRsaImpl.calculate(TokenCodec.base64Encode(rsa256),
                    TokenCodec.base64Encode(payload), new PrivateKey(rsaPrivKey)));
    }
